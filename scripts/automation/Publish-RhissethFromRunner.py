...
if len(sys.argv) != 3 or sys.argv[1] != RID or sys.argv[2] not in ('publish','publish-v03','publish-v031','publish-v032','publish-v033','publish-v034'): raise SystemExit('Invalid operation')
...
def main():
    ...
    name = {'publish-v03':'Publish-BatellV03Vps.py','publish-v031':'Publish-BatellV031Vps.py','publish-v032':'Publish-BatellV032Vps.py','publish-v033':'Publish-BatellV033Vps.py','publish-v034':'Publish-BatellV034Vps.py'}.get(sys.argv[2], 'Publish-RhissethVps.py')
    ...
    interpreter = '/opt/rhisseth/venv/bin/python' if sys.argv[2] in ('publish-v03','publish-v031','publish-v032','publish-v033','publish-v034') else 'python3'
