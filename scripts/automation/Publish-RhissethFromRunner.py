...
if len(sys.argv) != 3 or sys.argv[1] != RID or sys.argv[2] not in ('publish','publish-v03','publish-v031'): raise SystemExit('Invalid operation')
...
def main():
    ...
    name = {'publish-v03':'Publish-BatellV03Vps.py','publish-v031':'Publish-BatellV031Vps.py'}.get(sys.argv[2], 'Publish-RhissethVps.py')
    ...
    interpreter = '/opt/rhisseth/venv/bin/python' if sys.argv[2] in ('publish-v03','publish-v031') else 'python3'
