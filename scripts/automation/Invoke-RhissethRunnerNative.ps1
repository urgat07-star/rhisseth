...
param([string]$ResourceId = '',
      ...
      [ValidateSet('inspect', 'install', 'validate', 'hosting', 'snapshot', 'publish-map', 'audit-map', 'deploy-hexes', 'publish', 'publish-v03', 'publish-v031', 'publish-v032', 'publish-v033', 'publish-v034', 'apply')][string]$Operation = 'inspect')
...
try {
    ...
    if ($ScriptName -eq 'Publish-RhissethFromRunner.py') {
        $payloadName = if ($Operation -eq 'publish-v03') { 'Publish-BatellV03Vps.py' } elseif ($Operation -eq 'publish-v031') { 'Publish-BatellV031Vps.py' } elseif ($Operation -eq 'publish-v032') { 'Publish-BatellV032Vps.py' } elseif ($Operation -eq 'publish-v033') { 'Publish-BatellV033Vps.py' } elseif ($Operation -eq 'publish-v034') { 'Publish-BatellV034Vps.py' } else { 'Publish-RhissethVps.py' }
    ...
    if ($ScriptName -eq 'Publish-RhissethFromRunner.py') {
        ...
        $archiveRef = if ($Operation -eq 'publish-v031') { 'v0.3.1' } elseif ($Operation -eq 'publish-v032') { 'v0.3.2' } elseif ($Operation -eq 'publish-v033') { 'v0.3.3' } elseif ($Operation -eq 'publish-v034') { 'v0.3.4' } else { 'HEAD' }
