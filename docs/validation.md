...
После переноса хостинга: 5 локальных тестов OK. На VPS сохранены 2 пользователя
и 3 роли из SQL archive; проверены все поля без вывода значений. Login/logout,
registration, CSRF, viewer/editor permissions и restart persistence прошли.
Страница входа извне 200; API без сессии 401, карта без сессии 303 на вход.
Все 667 гексов сохранены, checksum совпал с первым выпуском. Создан новый dump.
Текущий вход использует site accounts вместо исторической Basic Auth.
